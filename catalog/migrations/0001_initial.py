    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(help_text='Введите дату рождения', max_length=100, verbose_name='Дата рождения')),
                ('last_name', models.CharField(help_text='Введите дату смерти', max_length=100, verbose_name='Дата смерти')),
                ('date_of_birth', models.DateField(blank=True, null=True, verbose_name='')),
                ('date_of_death', models.DateField(blank=True, null=True, verbose_name='')),
            ],
        ),
        migrations.CreateModel(
            name='Book',
            fields=[
                ...
                ('summary', models.TimeField(help_text='Введите краткое описание книги', max_length=1000, verbose_name='Аннотация книги')),
